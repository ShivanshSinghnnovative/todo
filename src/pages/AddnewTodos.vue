<template>
    <div class="todoBox">
        ...
        <div v-if="errorMessage.length != 0 && title.length == 0" class="error">* please enter title</div>
        <h4 class="title">DETAILS</h4>
        <textarea class="detailBox" v-model="details" rows="4" cols="30"></textarea>
        <div v-if="errorMessage.length != 0 && details.length == 0" class="error">* please enter details</div>
